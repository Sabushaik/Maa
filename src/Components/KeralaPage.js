...
<h1 className="h1sabu" style={{marginTop:'10px' ,padding:'30px'}} >Welcome To Kerala Section</h1> 
...
<div className="horizontal-row-container">
        ...
        <h2> Explore Kerala : Your Gateway to the kerala </h2>
        <p>
...
<img
          src={Kerala} // Placeholder image URL
          alt="Placeholder"
        />
</div>
